...
import doctorstethoscope from '../assets/health-profile-02.jpg';
//
    ...
    return (
        <div className="container d-flex flex-row align-items-center pt-4 mt-4 w-100">
            <div className='w-50 px-5 d-flex flex-column align-items-center'>
                <img src={doctorstethoscope} alt="Doctor interviewing patient" className="img-fluid rounded shadow w-75" />
            </div>
